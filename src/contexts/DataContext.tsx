...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            console.warn("Backend belum siap, menggunakan data lokal:", err.message);
            // Fallback ke data lokal jika API error 404/Not Found
            setData(initialData);
